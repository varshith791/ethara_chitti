          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-slate-500">Project: {task.projectId?.title}</p>
              </div>
            ...
            {canEdit && (
              <form onSubmit={handleUpdateTask} className="mt-8 space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <input value={assignedTo} onChange={(e) => setAssignedTo(e.target.value)} placeholder="Assigned user ID" className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3" />
